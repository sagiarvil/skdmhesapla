...
### 6.3 Pasaport Zemini (Guilloche) Sistemi — sayfa geneli kimlik katmanı (v1.3)

Markanın "değerli evrak / mühürlü dosya" kimliğini sayfanın tamamına taşıyan imza dokusu: **para, pasaport ve değerli evraklardaki gravür çizgi dilinin (guilloche)** dijital karşılığı. Amaç: ziyaretçi sayfayı kaydırırken "bu site resmi, mühürlü, güvenilir bir belge üretiyor" hissini bilinçaltında alsın.

**Motif tanımı:**
- İç içe geçen sinüzoidal dalga çizgileri + köşelerde spirograph/rozet elemanları (banknot çerçevelerindeki interferans desenleri)
- Tekrarlayan **tek SVG tile** (480×480 px) olarak üretilir; kod ile parametrik çizilir (faz kaymalı sinüs eğrileri üst üste — interferans dokusu)
- Çizgi kalınlığı 0,6 px; gerçek pasaport hissi için çizgiler düz değil, hafif titreşimli (hand-engraved hissi veren mikro varyasyon)

**İki renk varyantı:**

| Yüzey | Çizgi rengi | Opacity | Görünürlük |
|---|---|---|---|
| Açık section'lar (beyaz / soft degrade) | `--ink-900` | %3,5 | Bilinçaltı doku — metni asla ezmez |
| Koyu yüzeyler (hero, footer) | `--brand-500` (fıstık) | %6–8 | Belirgin ama içeriği boğmayan gravür parıltısı |
...
1. Elmas mozaik deseni (sağ yarı) **korunur** + üzerine guilloche pasaport dokusu (%6, fıstık) biner — iki doku farklı ölçekte olduğu için zenginleştirir, çakışmaz
