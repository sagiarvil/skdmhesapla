...
const GLOBAL_MESSAGES = path.join(USER_HOME, ".gemini", "config", "plugins", "claude-messages-suite", "messages");
const DESKTOP_MESSAGES = path.join(USER_HOME, "Desktop", "plugins", "claude", "claude-messages-suite", "messages");
