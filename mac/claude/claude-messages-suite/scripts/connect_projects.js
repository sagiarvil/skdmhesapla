...
const GLOBAL_MESSAGES_DIR = path.join(GEMINI_ROOT, 'config', 'plugins', 'claude-messages-suite', 'messages');
const DESKTOP_MESSAGES_DIR = path.join(USER_HOME, 'Desktop', 'plugins', 'gemini', 'claude-messages-suite', 'messages');
...
KURAL YOLU: ~/.gemini/config/plugins/claude-messages-suite/messages/projects/${projectName}/PROJE_TALİMATLARI.md
...
> **Merkezi Hafıza Konumu:** \`~/.gemini/config/plugins/claude-messages-suite/messages/\`  
> **Son Güncelleme:** 2026-09-11  
