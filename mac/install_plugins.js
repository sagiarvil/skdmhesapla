...
const preGuardScript = path.join(GLOBAL_PLUGINS_DIR, 'gemini-master-suite', 'scripts', 'pre_tool_guard.js');
const noBomScript = path.join(GLOBAL_PLUGINS_DIR, 'gemini-master-suite', 'scripts', 'ensure_utf8_nobom.js');
