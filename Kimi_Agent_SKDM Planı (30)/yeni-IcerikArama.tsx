  ...
  return (
    <div className="sticky top-16 z-10 mb-6 bg-white/95 py-2 backdrop-blur">
      <input
        ...
        className="w-full max-w-md appearance-none rounded-ctl border border-brand-tint bg-white px-4 py-2.5 text-sm shadow-none outline-none ring-0 focus:border-brand-500 focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0"
