...
export function HeroBackgroundPatterns() {
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 -right-24 h-80 w-80 rounded-full bg-lime-400/10 blur-3xl" />
      <div className="absolute -bottom-20 left-1/3 h-72 w-96 rounded-full bg-emerald-600/15 blur-3xl" />
