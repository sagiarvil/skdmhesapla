  ...
  return (
    <div className="w-full space-y-16 sm:space-y-24 pb-16">
      ...
      <section className="mx-auto max-w-6xl px-5 sm:px-6 pt-6">
        <div className="rounded-[2.5rem] bg-rose-50/70 p-8 sm:p-12 border-2 border-rose-200 shadow-sm">
      ...
      <section className="mx-auto max-w-6xl px-5 sm:px-6">
        ...
        <div className="grid gap-8 lg:grid-cols-12 lg:items-stretch">
          ...
          <div className="lg:col-span-6 flex flex-col justify-between rounded-[2.5rem] bg-gradient-to-br from-[#020b14] via-[#05192d] to-[#082942] p-7 sm:p-9 text-white shadow-xl border border-cyan-500/20">
            <div>
      ...
      <section className="mx-auto max-w-6xl px-5 sm:px-6">
        ...
        <div className="relative mx-auto max-w-5xl rounded-[2.5rem] bg-gradient-to-b from-[#f0f7fc] to-white p-6 sm:p-9 border-2 border-sky-200 shadow-md">
      ...
      <section className="mx-auto max-w-6xl px-5 sm:px-6">
        ...
        <div className="grid gap-8 lg:grid-cols-12 lg:items-stretch">
          <div className="lg:col-span-5 rounded-[2.5rem] bg-[#f0f7fc] p-8 border-2 border-sky-200 flex flex-col justify-between">
            <div>
          ...
          <div className="lg:col-span-7 rounded-[2.5rem] bg-gradient-to-br from-[#020b14] via-[#05192d] to-[#082942] p-7 sm:p-9 text-white shadow-xl border border-cyan-500/20">
      ...
      <section className="mx-auto max-w-6xl px-5 sm:px-6">
        ...
        <div className="relative rounded-[2.5rem] bg-gradient-to-r from-[#020b14] via-[#072138] to-[#020b14] p-8 sm:p-10 text-white shadow-2xl overflow-hidden border border-cyan-500/20">
      ...
      <section className="mx-auto max-w-6xl px-5 sm:px-6">
        ...
        <div className="grid gap-8 lg:grid-cols-12 lg:items-center">
          <div className="lg:col-span-7 rounded-[2.5rem] bg-[#f0f7fc] p-7 sm:p-9 border-2 border-sky-200">
      ...
      {/* ========================================================================= */}
      <section className="mx-auto max-w-6xl px-5 sm:px-6">
        <div className="rounded-[2.5rem] bg-gradient-to-br from-[#020b14] via-[#05192d] to-[#082942] p-8 sm:p-12 text-white shadow-2xl text-center border border-cyan-500/20">
