...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    "AB CBAM/SKDM güncellemelerini kaynak türü, hukuki ağırlığı, Türk ihracatçıya etkisi ve yapılacak kontrolle birlikte Google Akademi indeks yapısında izleyin.",
});
