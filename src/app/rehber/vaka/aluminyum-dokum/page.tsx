...
export const metadata = pageMetadata({
  path: '/rehber/vaka/aluminyum-dokum/',
  title: 'Alüminyum Döküm SKDM Örneği | SKDMHesapla Vaka Analizi',
  description: 'Alüminyum Döküm SKDM Örneği ve emisyon tahsisi analizi.'
});

export default function VakaPage() {
  return (
    <article className="max-w-4xl mx-auto py-10 px-6">
      <RegistryJsonLd route="/rehber/vaka/aluminyum-dokum/" />
      ...
      <h1 className="text-3xl font-bold mb-6">Alüminyum Döküm SKDM Örneği</h1>
      
      <div className="space-y-6">
        <section className="bg-white p-6 rounded-lg border">
          <h2 className="text-xl font-semibold mb-3">1. Senaryo ve Varsayımlar</h2>
          <ul className="list-disc pl-5 space-y-2">
            <li><strong>İlgili CN/GTİP Kodu:</strong> 7616 99</li>
        ...
        <section className="bg-white p-6 rounded-lg border">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="mt-1">Üretilen aluminyum dokum başına düşen tahmini gömülü emisyon değeri başarıyla hesaplanmıştır. Tesisinizdeki gerçek veri kullanılmalıdır.</p>
            </div>
          </div>
        </section>
