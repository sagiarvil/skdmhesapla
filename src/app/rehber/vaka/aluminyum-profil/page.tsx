...
export const metadata = pageMetadata({
  path: '/rehber/vaka/aluminyum-profil/',
  title: 'Alüminyum Profil SKDM Hesaplama Örneği | SKDMHesapla Vaka Analizi',
  description: 'Alüminyum Profil SKDM Hesaplama Örneği ve emisyon tahsisi analizi.'
});

export default function VakaPage() {
  return (
    <article className="max-w-4xl mx-auto py-10 px-6">
      <RegistryJsonLd route="/rehber/vaka/aluminyum-profil/" />
      ...
      <h1 className="text-3xl font-bold mb-6">Alüminyum Profil SKDM Hesaplama Örneği</h1>
      
      <div className="space-y-6">
        <section className="bg-white p-6 rounded-lg border">
          <h2 className="text-xl font-semibold mb-3">1. Senaryo ve Varsayımlar</h2>
          <ul className="list-disc pl-5 space-y-2">
            <li><strong>İlgili CN/GTİP Kodu:</strong> 7604</li>
        ...
        <section className="bg-white p-6 rounded-lg border">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="mt-1">Üretilen aluminyum profil başına düşen tahmini gömülü emisyon değeri başarıyla hesaplanmıştır. Tesisinizdeki gerçek veri kullanılmalıdır.</p>
            </div>
          </div>
        </section>
