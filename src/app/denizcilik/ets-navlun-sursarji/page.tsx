...
import { ArrowRight, ShieldAlert, CheckCircle2, AlertTriangle, Scale, Calculator, ArrowUpRight, Ship } from "lucide-react";
...
export default function EtsNavlunSursarjiPage() {
  return (
    <main className="min-h-screen bg-white text-ink-900">
      ...
      <section className="relative overflow-hidden border-b border-sky-950/40 bg-gradient-to-b from-[#020b14] via-[#05192d] to-[#082942] pt-14 pb-16 text-white">
        <div className="relative mx-auto max-w-5xl px-5 sm:px-6 z-10">
          ...
          <div className="mt-8 flex flex-wrap gap-3.5">
            ...
            >
              <span>Hemen Başla: Klas Denetimine Hazır Gemi Paketini Oluşturun (599 USD)</span>
      ...
      {/* Simulator Section */}
      <section id="hesaplayici" className="scroll-mt-20 py-16 bg-slate-50/50">
