      ...
      <div className="mx-auto max-w-3xl space-y-8 px-5 sm:px-6">
        ...
        <div className="rounded-3xl border-2 border-brand-800/25 bg-white p-7 shadow-xl sm:p-9 space-y-6">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-black text-ink-900">Veri Güvenliği ve Gizlilik</h2>
          </div>

          <div className="space-y-4 text-base sm:text-lg leading-relaxed text-ink-700 font-medium">
            <p>
              SKDMHesapla olarak, 6698 sayılı Kişisel Verilerin Korunması Kanunu (&ldquo;KVKK&rdquo;) ve Avrupa Birliği Genel Veri Koruma Tüzüğü (&ldquo;GDPR&rdquo;) uyarınca veri sorumlusu sıfatıyla hareket etmekteyiz.
            </p>
            <p>
            ...
            <p>
              <strong>2. Verilerin Saklanması:</strong> Verileriniz üçüncü şahıslara veya reklam ağlarına satılmaz. Üretilen mühürlü dosyalarınız şifrelenmiş sunucularımızda güvenle muhafaza edilir.
            </p>
          </div>
        </div>
      </div>
