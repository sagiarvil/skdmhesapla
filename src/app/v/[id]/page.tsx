...
export async function generateMetadata({ params }: VerificationPageProps): Promise<Metadata> {
  ...
  return pageMetadata({
    path: `/v/${id}`,
    title: `Rapor Bütünlük Doğrulaması (#${id.slice(0, 8)}) | SKDMHesapla`,
    description: "SKDMHesapla mühürlü denetime hazırlık raporunun metodoloji sürümü, SHA-256 bütünlüğü ve uzmanlık sorumluluğu doğrulaması.",
    noIndex: true,
  });
}
