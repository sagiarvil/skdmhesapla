    ...
    <>
      ...
      <main className="bg-white text-ink-900">
        ...
        <div className="hidden md:block">
          ...
          {/* ========================================================================= */}
          <section data-chunk-id="hero-cbam-scope" className="border-b-4 border-emerald-600 bg-gradient-to-br from-[#04150f] via-[#0a2c1e] to-[#051c14] text-white py-16 sm:py-24 relative overflow-hidden pk-hero">
            ...
            <div className="mx-auto max-w-6xl px-5 sm:px-6 relative z-10">
              ...
              <div className="mx-auto mt-10 max-w-3xl rounded-[2.5rem] bg-white p-6 sm:p-9 shadow-2xl border-4 border-emerald-600/40 text-slate-900 pk-card-plain">
              ...
              <div className="mt-8 flex flex-wrap justify-center gap-4">
                <Link href="/basla/" className="inline-flex min-h-14 items-center gap-2 rounded-2xl bg-emerald-500 px-8 text-base font-black text-slate-950 shadow-xl transition hover:bg-emerald-400 pk-btn-primary">
