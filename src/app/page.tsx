        ...
        <div className="hidden md:block">
          ...
          <section data-chunk-id="hero-cbam-scope" className="border-b border-sky-200/40 bg-gradient-to-br from-[#0284c7] via-[#38bdf8] to-[#7dd3fc] text-white py-16 sm:py-24 relative overflow-hidden pk-hero">
            ...
            <div className="mx-auto max-w-6xl px-5 sm:px-6 relative z-10">
              ...
              <div className="mx-auto mt-10 max-w-3xl rounded-[2.5rem] bg-white p-6 sm:p-9 shadow-2xl border-4 border-sky-300/40 text-slate-900 pk-card-plain">
                <div className="mb-4 flex items-center justify-between border-b border-slate-100 pb-3">
                  ...
                  <span className="rounded-full bg-sky-50 px-3 py-1 text-[11px] font-black text-[#0284c7] border border-sky-200">
                    Ücretsiz Sorgu
                  </span>
                </div>
                <GtipArama />
