export const CBAM_VERIFICATION_WORKFLOW = {
  ...
  flow: [
    ...
    "NCA akreditasyon kontrolü ve erişim onayı",
    "CBAM Registry üzerinden verification report",
  ],
  calculationImpact: "NONE",
  calculationImpactNote:
    "24 Ağustos 2026 verification/accreditation guidance gömülü emisyon formülünü, default values veri setini, benchmark değerlerini veya ETS maliyet hesabını değiştirmez.",
  defaultValuesStatus:
