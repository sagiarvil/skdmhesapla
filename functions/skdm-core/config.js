...
exports.SKDM_SECTORS = exports.PADDLE_SEAL_PRICE_TRY = exports.CBAM_ANNUAL_DECLARATION_DEADLINE = exports.CBAM_CERTIFICATE_SALES_START_DATE = exports.CBAM_QUARTERLY_HOLDING_RATIO = exports.CBAM_DE_MINIMIS_TONS_THRESHOLD = exports.CBAM_DECAY_SCHEDULE = exports.DEFAULT_EUR_TRY_RATE = exports.TR_ETS_PILOT_END_YEAR = exports.DEFAULT_TR_ETS_PRICE_EUR = exports.DEFAULT_EU_ETS_PRICE_EUR = exports.DEFAULT_ETS_QUARTER = exports.ETS_PRICE_QUARTERLY = exports.etsPriceQuarterly = exports.ANNEX_II_SADECE_DIREKT = exports.SKDM_RULESET_VERSION = void 0;
exports.resolveTrEtsNettingEur = resolveTrEtsNettingEur;
exports.SKDM_RULESET_VERSION = "2026.1-Omnibus1";
/** Annex II: yalnız doğrudan emisyon faturaya girer (demir-çelik, alüminyum, elektrik, hidrojen). */
exports.ANNEX_II_SADECE_DIREKT = new Set([
    "iron-steel",
    "aluminum",
    "electricity",
    "hydrogen",
...
exports.etsPriceQuarterly = {
    "2026-Q1": 75.4, // Q1 2026 AB ETS Çeyreklik Ortalama Fiyatı (75.4 €/tCO2e)
    "2026-Q2": 78.0,
    "2026-Q3": 80.0,
    "2026-Q4": 82.5,
};
exports.ETS_PRICE_QUARTERLY = exports.etsPriceQuarterly;
exports.DEFAULT_ETS_QUARTER = "2026-Q1";
exports.DEFAULT_EU_ETS_PRICE_EUR = exports.etsPriceQuarterly[exports.DEFAULT_ETS_QUARTER]; // 75.4 €/tCO2e
/** Pilot dönem (2026–2027): TR-ETS %100 ücretsiz tahsis → mahsup 0 (Ek G §15). */
exports.DEFAULT_TR_ETS_PRICE_EUR = 0;
exports.TR_ETS_PILOT_END_YEAR = 2027;
exports.DEFAULT_EUR_TRY_RATE = 38.5; // € / ₺ paritesi
/** Pilot yılda mahsup her zaman 0; sonrası kullanıcı/input değeri. */
function resolveTrEtsNettingEur(year, input) {
    if (year <= exports.TR_ETS_PILOT_END_YEAR)
        return 0;
    return Math.max(0, typeof input === "number" ? input : exports.DEFAULT_TR_ETS_PRICE_EUR);
}
// CBAM Ücretsiz Tahsisat Azalım Takvimi (Free Allocation Decay Factor - EU 2023/956 & 2025/2083)
exports.CBAM_DECAY_SCHEDULE = {
...
exports.CBAM_DE_MINIMIS_TONS_THRESHOLD = 50; // Yıllık 50 ton altı de minimis muafiyeti
exports.CBAM_QUARTERLY_HOLDING_RATIO = 0.50; // Çeyreklik hesapta bulundurma oranı (%50)
exports.CBAM_CERTIFICATE_SALES_START_DATE = "2027-02-01"; // Sertifika satış başlangıcı
exports.CBAM_ANNUAL_DECLARATION_DEADLINE = "30 Eylül"; // Yıllık beyan tarihi (ertesi yıl 30 Eylül)
exports.PADDLE_SEAL_PRICE_TRY = 9900;
exports.SKDM_SECTORS = {
    // --- KADEME A: DOĞRUDAN SKDM (TÜZÜK 2023/956 & 2025/2083 OMNIBUS-I) ---
    "iron-steel": {
        id: "iron-steel",
        name: "Demir & Çelik",
        tier: "A",
        cnCodes: ["7201-7203", "7205-7229", "7301-7311", "7318", "7326", "2601 12 00"],
        unit: "ton",
