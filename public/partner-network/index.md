...
- HTML sayfa: https://skdmhesapla.com/partner-network/
- Kapsam kontrolü: https://skdmhesapla.com/basla/
- Sonraki işlem: GTİP/CN ile kapsamınızı kontrol edin.

## Sınırlar

- SKDMHesapla teknik üretim altyapısıdır; akredite CBAM doğrulayıcısı, AB makamı veya authorised CBAM declarant değildir ve resmî kabul garantisi vermez.
