# Elektrik: sektör ailesi ve CN kararı

> Elektrik sektör ailesi SKDM Kademe A'dadır; hukuki kapsam tek bir CN/GTİP doğrulamasına bağlıdır. Ürün adı yeterli değildir.

> **Semantik Varlık Bilgisi (RDF Triples):**
> - Özne (Subject): https://skdmhesapla.com/sektor/elektrik/
...
Bu doküman, Elektrik SKDM kapsamı — CN/GTİP kararı konusundaki teknik karar ağacını ve hesaplama sınırlarını doğrudan resmî AB mevzuatı temelinde özetler.
...
- HTML sayfa: https://skdmhesapla.com/sektor/elektrik/
