# Çimento: sektör ailesi ve CN kararı

> Çimento sektör ailesi SKDM Kademe A'dadır; hukuki kapsam tek bir CN/GTİP doğrulamasına bağlıdır. Ürün adı yeterli değildir.

> **Semantik Varlık Bilgisi (RDF Triples):**
> - Özne (Subject): https://skdmhesapla.com/sektor/cimento/
...
Bu doküman, Çimento SKDM kapsamı — CN/GTİP kararı konusundaki teknik karar ağacını ve hesaplama sınırlarını doğrudan resmî AB mevzuatı temelinde özetler.
...
- sector-family
- cn-gtip
- annex-ii-direct-only
- de-minimis-eligibility

## Nasıl kullanılır

- HTML sayfa: https://skdmhesapla.com/sektor/cimento/
- Kapsam kontrolü: https://skdmhesapla.com/basla/
- Sonraki işlem: GTİP/CN ile kapsamınızı kontrol edin.

## Sınırlar

- Sistem akredite doğrulama görüşü veya gümrük onayı vermez. Kapsam kararı doğrulanmış CN/GTİP sınıflandırmasına bağlıdır. Annex II yalnız-direkt: hayır (dolaylı emisyon faturaya girebilir).
