...
> Dijital mühürlü paket için iade ve cayma koşulları.

> **Semantik Varlık Bilgisi (RDF Triples):**
> - Özne (Subject): https://skdmhesapla.com/iade-politikasi/
...
Bu doküman, İade politikası konusundaki teknik karar ağacını ve hesaplama sınırlarını doğrudan resmî AB mevzuatı temelinde özetler.
...
- HTML sayfa: https://skdmhesapla.com/iade-politikasi/
- Kapsam kontrolü: https://skdmhesapla.com/basla/
- Sonraki işlem: GTİP/CN ile kapsamınızı kontrol edin.

## Sınırlar

- Dijital teslimat kuralları kullanım koşullarıyla birlikte okunur.
