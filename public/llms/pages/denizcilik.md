...
> Hizmet Fiyatı: $399 (1 gemi · 1 raporlama yılı · tek seferlik)
...
- `Subject`: https://skdmhesapla.com/#organization
  ...
  - `Predicate`: `hasPrice` -> `Object`: $399 USD (Per Ship / Per Reporting Year)
...
**Cevap:** Denizcilik Karbon Uyum Hazırlık Dosyası; armatörler, gemi işletmecileri (ISM Companies) ve lojistik yöneticileri için geminin tüm takvim yılı seferlerini, yakıt tüketimlerini ve BDN (Bunker Delivery Notes) kanıtlarını AB standartlarına göre derleyen teknik denetim paketidir. Ücreti **1 gemi ve 1 raporlama yılı için tek seferlik $399**'dır. Abonelik veya gizli maliyet içermez.
