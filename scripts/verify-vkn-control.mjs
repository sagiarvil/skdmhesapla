...
check("GATE-1 Test1: Tüzel firma + 11 hane → engelleyici bulgu", hasBlockingQc(t1));
const t2 = checkTaxIdField(firma, "0000000000", "turel", "turel");
check("GATE-1 Test2: Tüzel firma + geçersiz checksum'lı 10 hane → engelleyici bulgu", hasBlockingQc(t2));
const t3 = checkTaxIdField("Mehmet Demir", "10000000146", "sahis", "sahis");
check("GATE-1 Test3: Şahıs firması + geçerli 11 hane → kabul (engel yok)", !hasBlockingQc(t3));
