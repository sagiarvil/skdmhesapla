...
const entries = [
  ...
  e({
    ...
    conversionEvent: "organic_scope_check_started",
    parentHub: "/rehber/",
    relatedRoutes: ["/basla/", "/rehber/", "/karbon-raporu/"],
    limitations: LIMIT_NO_OPINION,
    legalClaims: true,
    sourceRefs: SRC_OMNI,
  }),
  ...
  e({
    ...
    relatedRoutes: ["/karbon-raporu/"],
    limitations: "Tek hop 301. Indexable owner /karbon-raporu/ adresidir.",
    legalClaims: true,
    sourceRefs: ["agents1"],
  }),
  e({
    ...
    role: "toolLanding",
    state: "PUBLISHED_INDEXABLE",
    title: "Ürün karbon ayak izi raporu hazırla",
    metaDescription:
    ...
    h1: "Alıcınıza göndereceğiniz ürün karbon raporunu hazırlayın.",
    primaryIntent: "buyer-product-carbon-report",
    schemaTypes: ["WebPage", "SoftwareApplication"],
    uniqueValueTypes: ["pcf-wizard", "factor-provenance", "buyer-report"],
    decisionEnabled: true,
    uniqueDecisionFields: ["material-inventory", "energy", "allocation", "factor-quality"],
    conversionEvent: "pcf_wizard_started",
    parentHub: "/tedarikci-verisi/",
    relatedRoutes: ["/basla/", "/tedarikci-verisi/", "/metodoloji/", "/kapsam-disi-beyani/"],
    internalInLinks: ["/basla/", "/tedarikci-verisi/"],
    limitations:
      "Üretici tarafından sağlanan faaliyet verilerine dayanır; akredite doğrulama, ISO sertifikası, gümrük kararı veya CBAM beyanı değildir.",
    legalClaims: false,
    sourceRefs: ["iso-14067-2018", "wbcsd-pact-v3", "agents1"],
  }),
  e({
    ...
    conversionEvent: "organic_scope_check_started",
    relatedRoutes: ["/karbon-raporu/", "/basla/"],
    limitations: LIMIT_NO_OPINION,
    legalClaims: true,
    sourceRefs: SRC,
  }),
